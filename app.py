...
def generate_schedule(DAY_OF_WEEK, LEAVES, CUSTOM_TASKS, PART_TIME, FIX_BREAKS, FIXED_MAIN_TASKS, SICK_PEOPLE, IS_MWF):
    ...
    # 🌟 7. กฎ 1 ชั่วโมงเฉพาะงานหลัก (HARD RULE) บังคับใช้ทุกคน และทุกหมวดงาน 🌟
    all_work_categories = [
        dispensing_tasks,
        ver_cpoe_tasks,
        ver_ps_tasks,
...
st.markdown("<p style='font-size: 14px; color: gray;'>version 116.5 (06/05/2026) พัฒนาโดย Niratsai Sukprasert และ Gemini</p>", unsafe_allow_html=True)
    ...
    with pd.ExcelWriter(buffer, engine='openpyxl') as writer:
        ...
        for col_idx in range(1, num_columns + 1):
            ...
            for row_idx in range(3, len(df_to_show) + 4): 
                ...
                elif '/' in val_str and '-' in val_str and cell_val_str[0].isdigit():
