...
def generate_schedule(DAY_OF_WEEK, LEAVES, CUSTOM_TASKS, PART_TIME, FIX_BREAKS, FIXED_MAIN_TASKS, SICK_PEOPLE, IS_MWF):
    ...
    for pt in PART_TIME:
        ...
        # 🌟 แยกกลุ่มให้ถูกต้อง 100% ไม่ให้เวลาทับซ้อนกัน 🌟
        is_group_a = (pt['start'] == "09.30" and pt['end'] in ["16.00", "16.30"])
        # ตัด 13.00 ออกจาก group b
        ...
        if is_group_a: 
            ...
            # 🌟 กลุ่มเข้า 13.00 บังคับจ่าย 2 ชม. แบ่งเป็น 7 และ 8 ตามที่ต้องการ 🌟
    ...
    # 5. กฎจำกัดจำนวนคนต่อหน้าที่ (Ver 1 มีเสมอ)
    for t in range(16):
        for task in tasks:
    ...
    # 7. กฎ 1 ชั่วโมงเฉพาะงานหลัก (HARD RULE) เฉพาะ Full-time
    ...
    for p in ft_pharmacists:
        ...
        # HARD RULE: ลงช่อง 7 ห้ามลง 8 เด็ดขาด (เฉพาะ FT)
...
st.markdown("<p style='font-size: 14px; color: gray;'>version 115.7 (Fix PT Grouping) พัฒนาโดย Niratsai Sukprasert และ Gemini</p>", unsafe_allow_html=True)
